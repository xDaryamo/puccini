...
var ConstraintClauseSourceCode = map[string]string{
	"equal":            profile.Profile["/tosca/simple/1.1/js/equal.js"],
	"greater_than":     profile.Profile["/tosca/simple/1.1/js/greater_than.js"],
	"greater_or_equal": profile.Profile["/tosca/simple/1.1/js/greater_or_equal.js"],
	"less_than":        profile.Profile["/tosca/simple/1.1/js/less_than.js"],
	"less_or_equal":    profile.Profile["/tosca/simple/1.1/js/less_or_equal.js"],
	"in_range":         profile.Profile["/tosca/simple/1.1/js/in_range.js"],
	"valid_values":     profile.Profile["/tosca/simple/1.1/js/valid_values.js"],
	"length":           profile.Profile["/tosca/simple/1.1/js/length.js"],
	"min_length":       profile.Profile["/tosca/simple/1.1/js/min_length.js"],
	"max_length":       profile.Profile["/tosca/simple/1.1/js/max_length.js"],
	"pattern":          profile.Profile["/tosca/simple/1.1/js/pattern.js"],
}

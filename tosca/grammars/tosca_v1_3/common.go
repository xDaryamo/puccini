...
var log = logging.MustGetLogger("puccini.grammars.tosca_v1_3")
...
func init() {
	...
	Grammar.RegisterReader("NotificationOutput", tosca_v2_0.ReadNotificationOutput)         // introduced in TOSCA 1.3

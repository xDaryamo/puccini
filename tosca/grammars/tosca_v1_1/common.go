...
func init() {
	...
	DefaultScriptletNamespace.RegisterScriptlets(tosca_v2_0.ConstraintClauseScriptlets, tosca_v2_0.ConstraintClauseNativeArgumentIndexes, tosca.ConstraintScriptletPrefix+"schema")
}

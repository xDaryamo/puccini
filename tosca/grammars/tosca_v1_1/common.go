...
func init() {
	...
	DefaultScriptletNamespace.RegisterScriptlets(tosca_v2_0.ConstraintClauseScriptlets, tosca_v2_0.ConstraintClauseNativeArgumentIndexes, tosca.METADATA_CONSTRAINT_PREFIX+"schema")
}

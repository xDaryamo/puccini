  ...
  kubernetes.LabelSelector:
    ...
    properties:
      matchExpressions:
        ...
        type: list
        entry_schema: kubernetes.LabelSelectorRequirement
        required: false
      matchLabels:
        description: >-
  ...
  kubernetes.Pod:
    ...
    properties:
      ...
      containers:
        ...
        type: list
        entry_schema: kubernetes.Container
        constraints:
        - min_length: 1
      initContainers:
        description: >-
      ...
      volumes:
        ...
        type: list
        entry_schema: kubernetes.Volume 
        required: false
  ...
  kubernetes.Container:
    ...
    properties:
      ...
      ports:
        ...
        type: list
        entry_schema: kubernetes.ContainerPort
        required: false

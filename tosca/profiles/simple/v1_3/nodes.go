...
func init() {
	Profile["/tosca/simple/1.3/nodes.yaml"] = `
...
node_types:
  ...
  tosca.nodes.Abstract.Compute:
    ...
    description: >-
      The TOSCA Abstract.Compute node represents an abstract compute resource without any
      requirements on storage or network resources.
  ...
  tosca.nodes.Abstract.Storage:
    metadata:
      normative: 'true'
      citation: '[TOSCA-Simple-Profile-YAML-v1.3]'
      citation_location: 5.9.9
    description: >-
      The TOSCA Abstract.Storage node represents an abstract storage resource without any
      requirements on compute or network resources.
    properties:
      name:
        description: >-
